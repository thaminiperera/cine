...
import { SubscriptionButton } from "@/modules/suscriptions/ui/components/suscription-button";
import { useSubscription } from "@/modules/suscriptions/hooks/use-subscription";
      ...
      <div className="flex flex-col md:hidden">
        ...
        {userId === user.clerkId ? (
          ...
          <SubscriptionButton
            ...
            asSubscribed={user.viewerSubscribed}
            onClick={onClick}
